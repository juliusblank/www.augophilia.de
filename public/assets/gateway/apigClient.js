...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://brf4r3bwn9.execute-api.eu-central-1.amazonaws.com/prod';
    ...
    apigClient.participantsOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var participantsOptionsRequest = {
        ...
        return apiGatewayClient.makeRequest(participantsOptionsRequest, authType, additionalParams, config.apiKey);
    };
